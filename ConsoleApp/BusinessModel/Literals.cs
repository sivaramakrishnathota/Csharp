...
namespace BusinessModel
{
    ...
    {
        public static string UserOption = "enter the required option 1.Register , 2.login,0.exit,5.getvalue ";
        ...
        public static string notValidUserName = "username is not exist";
    }
}
